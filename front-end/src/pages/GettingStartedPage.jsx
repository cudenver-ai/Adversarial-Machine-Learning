    ...
    >
      ...
      <StyledCard sx={{ my: 4 }}>
        <StyledCardContent>
          ...
          <Typography variant="subtitle1" sx={{ mb: 2 }}>
            ...
            looking for a quick start or prefer more control, we’ve got an
            option that fits your style.
          </Typography>
          ...
          >
            <li>
              <b>Google Colab (Easy):</b> No installation needed. Just open it
              in your browser, and you’re good to go. Ideal for those who want
              to get straight to the action. 💻
            </li>
            <li>
              <b>Jupyter Notebook (Moderate):</b> Download our notebook and run
              it on your local machine. A bit more setup, but it gives you
              greater control over your environment. ⚙️
            </li>
            <li>
              <b>Local Setup (Advanced):</b> Want full control? Set everything
              up from scratch on your own system. A little more work upfront,
              but perfect for those who like to customize. 🛠️
            </li>
          </ul>
          ...
          <Typography variant="subtitle1" sx={{ mb: 2 }}>
            ...
            easiest setup, then move to the more advanced options as you need
            more flexibility.
          </Typography>
        </StyledCardContent>
      </StyledCard>
      <StyledCard sx={{ my: 4 }}>
        <StyledCardContent>
          ...
          <Typography variant="subtitle1" sx={{ mb: 2 }}>
            This section will guide you through setting up the project on your
            own machine. It involves installing dependencies and setting up your
          ...
          >
            ...
            <li>
              Ensure that Python is installed and compatible with the project
              (version 3.8 or higher).
            </li>
          </ul>

          <Typography variant="subtitle1" sx={{ mb: 2 }}>
            Once you’re ready, follow the steps below to begin the local setup
            process.
          </Typography>
          <Grid
            container
            ...
            <Grid item xs={12} md={6}>
              ...
              >
                ...
                >
                  ...
                  <li>
                    Run the following commands to install the required
                    libraries:
                    <ul
                      style={{
                        paddingLeft: '20px',
                    ...
                    >
                      ...
                      <li>
                        <code>Foolbox</code>: For generating adversarial
                        examples.
                      </li>
                    </ul>
                  </li>
                ...
                >
                  ...
                  <li>
                    Use <code>load_model</code> to load a pre-trained robust
                    model that is resistant to adversarial attacks.
                  </li>
                </ul>
                ...
                >
                  <li>
                    Download the CIFAR-10 dataset from the provided URL using
                    the following command:
                  </li>
                  <li>
                    Ensure the dataset is stored in the correct directory on
                    your system.
                  </li>
                </ul>
                ...
                <Divider sx={{ my: 4 }} />
                <Typography variant="body1" fontSize={18} lineHeight={1.8}>
                  Now that you have the CIFAR-10 dataset, we need to process it
                  to prepare for generating adversarial examples. Follow these
                  steps:
                </Typography>
                <ul
                  style={{
                ...
                <Typography variant="body1" fontSize={18} lineHeight={1.8}>
                  ...
                  dataset, which are required for generating adversarial
                  examples:
                </Typography>
                <ul
                  style={{
                ...
                <Divider sx={{ my: 4 }} />
                <Typography variant="body1" fontSize={18} lineHeight={1.8}>
                  It’s good practice to inspect your data before proceeding.
                  Let’s verify that the images and labels are correctly
                  formatted:
                </Typography>
                <ul
                  style={{
                ...
                >
                  <li>
                    Print the shape of the image and label tensors to confirm
                    they match the expected dimensions.
                  </li>
                  <li>
                    Check the pixel values to ensure they fall within the
                    correct range.
                  </li>
                </ul>
                ...
                >
                  <li>
                    Use the <code>RobustBench</code> library to load a
                    pre-trained robust model.
                  </li>
                  <li>
                ...
                <Divider sx={{ my: 4 }} />
                <Typography variant="body1" fontSize={18} lineHeight={1.8}>
                  To speed up computation, you can use a GPU if available. If
                  not, the script will fall back to using the CPU:
                </Typography>
                <ul
                  style={{
                    paddingLeft: '20px',
                ...
                >
                  ...
                  <li>
                    If no GPU is available, the script will automatically use
                    the CPU.
                  </li>
                </ul>
                ...
                <Divider sx={{ my: 4 }} />
                <Typography variant="body1" fontSize={18} lineHeight={1.8}>
                  In this step, we set up Foolbox to work with our PyTorch
                  model. Foolbox will allow us to run adversarial attacks on the
                  model:
                </Typography>
                <ul
                  style={{
                ...
                >
                  <li>
                    Measure the robust accuracy of the model under attack.
                  </li>
                  <li>
                ...
                <Typography variant="body1" fontSize={18} lineHeight={1.8}>
                  ...
                  counterparts to see how slight changes in the image can fool
                  the model:
                </Typography>
                <ul
                  style={{
                ...
                >
                  <li>
                    Select a random subset of images that were misclassified
                    after the attack.
                  </li>
                  <li>
